...
class ShowVegatableList extends StatefulWidget {
  ShowVegatableList(
  ...
  Color appbarcolor;
  @override
  State<ShowVegatableList> createState() => _ShowVegatableListState();
}

class _ShowVegatableListState extends State<ShowVegatableList> {
  var fireStoreDb =
      FirebaseFirestore.instance.collection('Vegatable').snapshots();
  @override
