...
class ShowSeaFoodList extends StatefulWidget {
  ShowSeaFoodList(
  ...
  Color appbarcolor;
  @override
  State<ShowSeaFoodList> createState() => _ShowSeaFoodListState();
}

class _ShowSeaFoodListState extends State<ShowSeaFoodList> {
  var fireStoreDb =
      FirebaseFirestore.instance.collection('SeaFood').snapshots();
  @override
