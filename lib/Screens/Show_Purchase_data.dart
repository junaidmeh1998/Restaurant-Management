...
class ShowPurchaseScreen extends StatefulWidget {
  ShowPurchaseScreen(
  ...
  Color appbarcolor;
  @override
  State<ShowPurchaseScreen> createState() => _ShowPurchaseScreenState();
}

class _ShowPurchaseScreenState extends State<ShowPurchaseScreen> {
  var fireStoreDb =
      FirebaseFirestore.instance.collection('PurchasingDetail').snapshots();
  @override
